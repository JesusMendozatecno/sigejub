{{-- reportes.blade.php - Centro de reportes y estadísticas: métricas de trabajadores/solicitudes/usuarios, gráficos por tipo de nómina y estatus, y tabla resumen del sistema. --}}
