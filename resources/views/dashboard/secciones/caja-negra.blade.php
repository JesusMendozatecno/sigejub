<header class="section-header">
    <div class="header-info">
        <h1><i data-lucide="hard-drive" size="22"></i> Historial</h1>
...
<div class="cn-toolbar">
    <div class="cn-search-wrap">
        <i data-lucide="search" size="16" class="cn-search-icon"></i>
...
<div class="cn-stats" id="cnStats">
    <div class="cn-stat-card cn-stat-total">
        <i data-lucide="database" size="22"></i>
...
<div class="modal-overlay" id="cnDetailModal">
    <div class="modal-box cn-detail-modal">
        <div class="cn-modal-head">
            <h3><i data-lucide="search" size="18"></i> Detalle del Registro</h3>
        ...
        try {
            ...
            tbody.innerHTML = data.data.map(a => {
                ...
                return `<tr>
                    ...
                    <td><button class="cn-btn-ghost" onclick="verDetalleCajaNegra(${a.id})" title="Ver detalle"><i data-lucide="eye" size="15"></i> Ver</button></td>
                </tr>`;
            }).join('');
