...
<body class="<?php echo e(auth()->user()->theme === 'dark' ? 'dark-mode' : ''); ?>">
        ...
        <?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $logs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="doc-day">
                ...
                <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <div class="doc-card <?php echo e($log->type); ?>">
                        <div class="doc-icon"><i class="fas <?php echo e($icon); ?>"></i></div>
                        <div class="doc-body">
                            <h3><?php echo e($log->commit_message); ?></h3>
                            <?php if($log->description): ?>
                                ...
                                <div class="doc-desc"><?php echo e($log->description); ?></div>
                            <?php endif; ?>
                            <div class="doc-meta">
                                <span class="author"><i class="fas fa-user"></i> <?php echo e($log->author_name); ?></span>
                                <?php if($log->section): ?><span class="badge badge-section"><?php echo e(ucfirst($log->section)); ?></span><?php endif; ?>
                                <span class="badge" style="background:<?php echo e(['feature'=>'#dcfce7','fix'=>'#fef3c7','security'=>'#fee2e2','improvement'=>'#dbeafe','style'=>'#ede9fe','docs'=>'#f1f5f9','change'=>'#f8fafc'][$log->type] ?? '#f1f5f9'); ?>;color:<?php echo e(['feature'=>'#16a34a','fix'=>'#d97706','security'=>'#dc2626','improvement'=>'#2563eb','style'=>'#7c3aed','docs'=>'#64748b','change'=>'#64748b'][$log->type] ?? '#64748b'); ?>"><?php echo e($typeInfo[0]); ?></span>
                                <span class="hash"><?php echo e(substr($log->commit_hash, 0, 8)); ?></span>
...
window.addEventListener('DOMContentLoaded', function() {
    if ('<?php echo e(auth()->user()->theme); ?>' === 'dark') document.body.classList.add('dark-mode');
});
...
<?php /**PATH C:\Users\RickUltra\Documents\Programacion\Programacion\Proyecto con jesus\sigejub-2\resources\views/usuarios/documentacion.blade.php ENDPATH**/ ?>