...
<head>
    ...
    <style>
        :root { --accent: <?php echo e(auth()->user()->accent_color ?? '#1a365d'); ?>; }
...
<script>
(function(){
    var theme = '<?php echo e(auth()->user()->theme); ?>';
        ...
        <div class="user-dropdown" id="userDropdown">
            <div class="dropdown-trigger" onclick="toggleDropdown()">
                ...
                <div style="text-align: left; display: block;">
                    <p style="margin:0; font-size: 0.85rem; font-weight: bold; line-height: 1; color: #1e293b;"><?php echo e(Auth::user()->name); ?></p>
                </div>
            ...
            <div class="dropdown-menu">
                <div class="dropdown-header">
                    <p style="margin:0; font-size: 0.85rem; font-weight: bold; color: #1e293b;"><?php echo e(Auth::user()->name); ?></p>
                    <span style="font-size: 0.75rem; color: #64748b;"><?php echo e(Auth::user()->email); ?></span>
                </div>
...
<script>window.SIGEJUB_THEME='<?php echo e(auth()->user()->theme); ?>';</script>
...
</html><?php /**PATH C:\Users\RickUltra\Documents\Programacion\Programacion\Proyecto con jesus\sigejub-2\resources\views/dashboard/index.blade.php ENDPATH**/ ?>