...
<head>
    ...
    <style>:root { --accent: <?php echo e($user->accent_color ?? '#1a365d'); ?>; }</style>
</head>
<body>
<div class="profile-wrapper">
    <div class="profile-header">
        ...
        <span class="text-muted">Último acceso: <?php echo e($user->last_login_at ? $user->last_login_at->diffForHumans() : 'Primer ingreso'); ?></span>
    </div>
    ...
    <div class="profile-layout">
        ...
        <div class="profile-sidebar">
            <div class="profile-card">
                ...
                <span class="profile-role <?php echo e($user->role === 'admin' ? 'role-admin' : 'role-analista'); ?>">
                    <?php echo e($user->role === 'admin' ? 'Administrador' : 'Analista'); ?>
        ...
        <div class="profile-content">
                ...
                <form id="formProfile">
                    <div class="grid-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" name="name" value="<?php echo e($user->name); ?>" required>
                        </div>
                        <div class="form-group">
                            <label>Correo electrónico</label>
                            <input type="email" class="form-input" name="email" value="<?php echo e($user->email); ?>" required>
                        </div>
                    </div>
            ...
            <div class="profile-tab" id="tab-seguridad">
                ...
                <div class="flex-between">
                    ...
                    <div class="toggle-switch <?php echo e($user->two_factor_enabled ? 'active' : ''); ?>" id="toggle2FA" onclick="toggleFA()"></div>
                </div>
            ...
            <div class="profile-tab" id="tab-configuracion">
                ...
                <div class="theme-toggle mb-4">
                    <div class="theme-option <?php echo e($user->theme === 'light' ? 'selected' : ''); ?>" data-theme="light" onclick="cambiarTema('light')">
                        <i class="fas fa-sun fa-fw"></i>
                        <span>Claro</span>
                    </div>
                    <div class="theme-option <?php echo e($user->theme === 'dark' ? 'selected' : ''); ?>" data-theme="dark" onclick="cambiarTema('dark')">
                ...
                <div style="max-width:200px;">
                    <select class="form-input" id="selectLanguage" onchange="cambiarIdioma(this.value)">
                        <option value="es" <?php echo e($user->language === 'es' ? 'selected' : ''); ?>>Español</option>
                ...
                <div class="color-presets" id="colorPresets">
                    ...
                    <div class="color-preset <?php echo e($user->accent_color === $c ? 'selected' : ''); ?>" style="background:<?php echo e($c); ?>;" data-color="<?php echo e($c); ?>" onclick="cambiarColor('<?php echo e($c); ?>')"></div>
                ...
                <div class="toggle-wrap">
                    ...
                    <select class="form-input" style="width:auto;padding:6px 10px;" id="notifEmail" onchange="guardarNotificaciones()">
                        <option value="all" <?php echo e($user->notification_email === 'all' ? 'selected' : ''); ?>>Todas</option>
                        <option value="important" <?php echo e($user->notification_email === 'important' ? 'selected' : ''); ?>>Solo importantes</option>
                        <option value="none" <?php echo e($user->notification_email === 'none' ? 'selected' : ''); ?>>Ninguna</option>
                    </select>
                </div>
                <div class="toggle-wrap">
                    ...
                    <select class="form-input" style="width:auto;padding:6px 10px;" id="notifSystem" onchange="guardarNotificaciones()">
                        <option value="all" <?php echo e($user->notification_system === 'all' ? 'selected' : ''); ?>>Todas</option>
                        <option value="important" <?php echo e($user->notification_system === 'important' ? 'selected' : ''); ?>>Solo importantes</option>
                        <option value="none" <?php echo e($user->notification_system === 'none' ? 'selected' : ''); ?>>Ninguna</option>
                    </select>
                </div>
                <div class="toggle-wrap">
                    <div><div class="toggle-label">Perfil público</div><div class="toggle-desc">Permitir que otros usuarios vean tu perfil</div></div>
                    <div class="toggle-switch <?php echo e($user->profile_public ? 'active' : ''); ?>" id="togglePrivacy" onclick="togglePrivacidad()"></div>
                </div>
            </div>
...
window.SIGEJUB_PROFILE_THEME='<?php echo e($user->theme); ?>';
window.SIGEJUB_ACCENT_COLOR='<?php echo e($user->accent_color ?? "#1a365d"); ?>';
</script>
<script defer src="<?php echo e(asset('js/profile.js')); ?>?v=<?php echo e(filemtime(public_path('js/profile.js'))); ?>"></script>
</body>
</html>
<?php /**PATH C:\Users\RickUltra\Documents\Programacion\Programacion\Proyecto con jesus\sigejub-2\resources\views/usuarios/user.blade.php ENDPATH**/ ?>