...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($a->user?->name ?? 'Sistema'); ?></td>
                <td><span class="badge badge-<?php echo e($a->action); ?>"><?php echo e(ucfirst($a->action)); ?></span></td>
                <td><?php echo e($a->subject_type ?? '—'); ?></td>
                <td><?php echo e(Str::limit($a->description, 80)); ?></td>
                <td style="font-family:monospace;"><?php echo e($a->ip_address ?? '—'); ?></td>
            </tr>
    ...
    <p class="footer">SIGEJUB v1.0 — Documento generado por <?php echo e(auth()->user()?->name ?? 'Sistema'); ?></p>
</body>
</html>
<?php /**PATH C:\Users\RickUltra\Documents\Programacion\Programacion\Proyecto con jesus\sigejub-2\resources\views/pdf/caja-negra.blade.php ENDPATH**/ ?>