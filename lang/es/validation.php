...
return [
    ...
    | defecto que usa el validador. Algunas de estas reglas tienen múltiples
    | versiones, como las reglas de tamaño. Siéntete libre de ajustar cada
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute dado aparece en una fuga de datos. Por favor elige un :attribute diferente.',
    ],
    ...
    | atributos que usen la convención "attribute.rule" para nombrar las
    | líneas. Esto hace que sea rápido especificar una línea de idioma
    | personalizada para una regla de atributo determinada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para intercambiar el
    | marcador de posición de nuestro atributo con algo más fácil de leer,
    | por ejemplo "Dirección de correo electrónico" en lugar de "email".
